...
import com.domain.SingleResponseObject;
...
public class UserApp1 {
    ...
    public static void main(String[] args) {
        ...
        File singleResponseFile = new File("src\\main\\resources\\singleUserResponse.json");
        String userData1File = "src\\main\\resources\\userData1.csv";
...
//            System.out.println("inside try");
            ...
            Person actualPerson = singleResponse.getData();

            List<Person> expectedPersons = csvParser.parsePersonFile(userData1File);
//            System.out.println("expected persons size " + expectedPersons.size());
